...
export function EditProfileModal({ profile, fetchProfile }: EditProfileModalProps) {
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <div className="col-span-3">
                                <FormFieldWrapper name="fullName" />
                            </div>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <div className="col-span-3">
                                <FormFieldWrapper name="website_url" />
                            </div>
                        </div>
                        <DialogFooter>
                            <Button type="submit" disabled={!isUsernameAvailable || isSubmitting}>
